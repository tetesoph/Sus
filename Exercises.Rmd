...
library(tidyverse)
Allbus <- read_dta("Allbus_STATA_format.dta")
```
...
### AN/ Problem: Change to pt01-pt20 (problem: gaps in consecutive order e.g. pt05) - Trust variables in German institutions
```{block, opts.label = "clues"}
